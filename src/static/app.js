document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateAuthUI() {
    ...
    authStatusText.textContent = isTeacherLoggedIn
      ? `Teacher: ${teacherUsername}`
      : "Student View";
    openLoginModalButton.classList.toggle("hidden", isTeacherLoggedIn);
    logoutButton.classList.toggle("hidden", !isTeacherLoggedIn);
    signupForm.classList.toggle("disabled", !isTeacherLoggedIn);
    teacherOnlyNote.classList.toggle("hidden", isTeacherLoggedIn);
  }
